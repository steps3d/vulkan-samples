...
//		mesh = createKnot ( device, 1, 4, 120, 30 );
		...
		//texture.load2D  ( device, "textures/texture.jpg", true );
		// 		std::string texName = "../../Textures/Cubemaps/skyrt.bmp;../../Textures/Cubemaps/skylf.bmp;../../Textures/Cubemaps/skydn.bmp;../../Textures/Cubemaps/skyup.bmp;../../Textures/Cubemaps/skybk.bmp;../../Textures/Cubemaps/skyfr.bmp";

		texture.loadCubemap ( device, {"textures/skybox/right.jpg", "textures/skybox/left.jpg", "textures/skybox/top.jpg", "textures/skybox/bottom.jpg", "textures/skybox/front.jpg", "textures/skybox/back.jpg"}, false );
...
//		descriptorPool.create ( device.getDevice (), swapChain.imageCount (), swapChain.imageCount (), swapChain.imageCount () );		
		descriptorPool
		...
		mesh->setVertexAttrs ( pipeline )
				.setDevice ( device )
				.setVertexShader   ( "shaders/shader.6.vert.spv" )
				.setFragmentShader ( "shaders/shader.6.frag.spv" )
